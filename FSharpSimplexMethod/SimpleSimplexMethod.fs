module private SimpleSimplexMethod
    ...
    let mutable private ArrayBazResult : int32[] = null
    ...
    let rec Пункт17И25 (A,B,C,z,resulArray(*,Оп*)(*,z0,w0*)): System.Collections.ArrayList =
           MatrixA <- A
           VecB <- B
           VecC <- C
           Z<-z
           ArrayBazResult<-resulArray
           levVecC()
           //17
           if Array.min VecC >= 0.0 then
                ...
                result.Add(ArrayBazResult)|>ignore
                result.Add(Опор)|>ignore
